= Crisply Jira Crawler[http://www.crisply.com]
...
* You can get your Crisply API key from the Profile page. Just click on your name in the upper right hand corner when logged into Crisply.
